 ...
 * MPG on the y-axis.
 */
function convertToTensor(data: MatchboxCar[]): Intermediate {
...
async function trainModel(model: tf.LayersModel, inputs: tf.Tensor<tf.Rank>, labels: tf.Tensor<tf.Rank>) {
